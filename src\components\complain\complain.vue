<template>
  <view class="demand">
    <view class="con-title">
      <span class="colorYellow">意见/投诉</span>
      -直达BOSS
    </view>
    ...
    <view class="flex mt15">
      <view class="con-Btn yellowBtn">+优化建议</view>
      <view class="con-Btn yellowBtn">+合作反馈</view>
      <view class="con-Btn yellowBtn">+员工投诉</view>
      <view class="con-Btn yellowBtn">+其他问题</view>
    </view>
    <view>
      <u-form :model="form" ref="uForm" label-width="100rpx">
        <u-form-item
          ...
          label-width="140"
        >
          <u-input v-model="form.title" placeholder="请输入意见/投诉" />
        </u-form-item>
        <u-form-item
          label="手机号"
          prop="phone"
