  ...
  <view class="page">
    ...
    <view class="box">
      ...
      <view class="boxCont mt10">
        <view
          class="detailsText fw600 mb10"
          style="border-left: 3px solid #45b2fd"
          >团队业绩</view
        >
        <view class="flexBetween">
          <view class="navItem">
      ...
      <view class="mt10">
        <u-cell-group class="f12">
          ...
          <u-cell-item
            title="企业申请"
            icon="home-fill"
            @click="cellChange('enterprise')"
          ></u-cell-item>
          <u-cell-item
            title="内部资料"
            icon="file-text-fill"
            @click="cellChange('internalDetail')"
          ></u-cell-item>
        </u-cell-group>
      </view>
    </view>
