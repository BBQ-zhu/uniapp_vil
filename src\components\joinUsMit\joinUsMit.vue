<template>
  <view class="demand">
    ...
    <view class="con-serve">
      <span class="f14">
        累计咨询：
        <u-count-to :start-val="0" :end-val="39525" separator="," duration='3000' font-size="28" color="#11BBB8" bold></u-count-to>
        次
      </span>
    ...
    <view>
      <u-form :model="form" ref="uForm" label-width="100rpx">
        ...
        <u-button class="mt15 blueBtn border50" type="warning" shape="square" @click="submit">立即加入</u-button>
      </u-form>
