<template>
  <view class="page" style="background:#fff;">
    ...
    <view class="action-btn-group footer">
      <u-button hover-class="none" type="primary" class="action-btn no-border buy-now-btn">在线咨询</u-button>
      <u-button hover-class="none" type="primary" class="action-btn no-border add-cart-btn" @click="handling">立即办理</u-button>
    </view>
  </view>
</template> 
